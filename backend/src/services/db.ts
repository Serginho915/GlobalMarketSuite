...
const fallbackDatabaseUrl = 'postgres://globalmarketsuite:globalmarketsuite@localhost:5432/globalmarketsuite';
...
export async function ensureSchema() {
  ...
  await query(`
    ...
    CREATE TABLE IF NOT EXISTS generated_posts (
      ...
      cover_image text NOT NULL DEFAULT '/covers/market-map.svg',
  ...
  await query(`ALTER TABLE generated_posts ADD COLUMN IF NOT EXISTS cover_image text NOT NULL DEFAULT '/covers/market-map.svg'`);
    ...
    for (const post of samplePosts) {
      await query(
        ...
        [
          ...
          post.coverImage || '/covers/market-map.svg',
          post.tags || [],
          post.seoTitle || null,
